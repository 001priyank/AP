...
using AudioProject.Infrastructure.Mappings;
...
namespace AudioProject
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            bool useInMemoryProvider = bool.Parse(Configuration["Data:AudioProjectConnection:InMemoryProvider"]);

            services.AddDbContext<AudioProjectContext>(options => {
